      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="mb-8 bg-orange-100 p-4 rounded-xl">
          ...
          <p className="text-center text-orange-700 mt-2">
            <span className="text-red-500">*</span> All fields marked with
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              ...
              <div className="relative group">
                ...
                />
                <MapPin
                  className="absolute left-3 top-1/2 -translate-y-1/2 text-blue-600 group-focus-within:animate-pulse"
                  size={20}
                />
              </div>
              {errors.cityName && (
